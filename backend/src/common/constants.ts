...
export const MSG: Record<string, Record<string, string>> = {
  en: {
    ...
    ask_email:
      'Got it, {name}! Do you have an email address? Reply with it or type *skip*.',
    email_saved:
      'Perfect! Your email has been saved. You can now send your order.',
    ...
    order_cancelled:
      "Your order has been cancelled. Feel free to reach out if you'd like to place a new order.",
    order_confirmed:
      "Your order #{order_id} has been confirmed. Thank you — we'll keep you updated.",
  ...
  fr: {
    welcome:
      'Welcome! Before we get started, could you please tell us your name?\nBienvenue ! Quel est votre nom ?\nأهلاً! ما اسمك؟',
    ask_email:
      'Compris, {name} ! Avez-vous une adresse email ? Répondez avec ou tapez *passer*.',
    email_saved:
      'Parfait ! Votre email a été enregistré. Vous pouvez maintenant passer votre commande.',
    email_skipped:
      'Pas de problème ! Vous pouvez maintenant passer votre commande.',
    ...
    total: '\nTotal : *{total} {currency}*',
    order_received:
      'Votre commande a bien été reçue. Nous vous contacterons sous peu.',
    order_cancelled:
      "Votre commande a été annulée. N'hésitez pas à nous contacter pour passer une nouvelle commande.",
    order_confirmed:
      'Votre commande #{order_id} a été confirmée. Merci — nous vous tiendrons informé.',
  ...
  ar: {
    ...
    order_cancelled:
      'تم إلغاء طلبيتك. لا تتردد في التواصل معنا لتقديم طلبية جديدة.',
    order_confirmed:
      'تم تأكيد طلبيتك رقم #{order_id}. شكراً لك — سنبقيك على اطلاع.',
