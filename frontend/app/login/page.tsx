    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-2.5 justify-center mb-8">
          ...
          <span className="font-semibold text-xl text-slate-900 dark:text-slate-100 tracking-tight">Suplr</span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm">
          <h1 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-1">{t("sign_in")}</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">{t("sign_in_sub")}</p>
