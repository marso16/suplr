            ...
            <table className="w-full text-sm min-w-[400px]">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
                  ...
                  <th className="text-end px-4 py-3 text-[11px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wide">
                    {t("col_qty")}
                  </th>
                  <th className="text-end px-4 py-3 text-[11px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wide">
                    {t("col_unit")}
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {order.items.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 text-end font-mono text-slate-600 dark:text-slate-400 tabular-nums">
                      {item.quantity}
                    </td>
