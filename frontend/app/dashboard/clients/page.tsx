  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6">
        {/* Header */}
        <div className="mb-5">
        ...
        <form onSubmit={submit} className="space-y-4">
          {/* Operation toggle */}
          <div className="flex border border-slate-200 dark:border-slate-700 text-sm">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full bg-transparent border-b border-slate-300 dark:border-slate-600 pl-7 pr-4 py-2 text-sm text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 transition-colors"
              />
            </div>
          </div>
          ...
          {/* Preview */}
          {delta > 0 && (
            <div className="flex items-center justify-between px-3 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              className="flex-1 py-2.5 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
            >
      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-6 flex-shrink-0">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          {clients.length > 0 && totalOutstanding > 0 && (
            <div className="flex items-center gap-1.5 px-3.5 py-2 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20">
              <svg
                width="13"
                height="13"
                fill="none"
          ...
          <div className="flex items-center gap-2 mt-4 flex-wrap">
            <div className="relative flex-1 min-w-0 max-w-xs">
              ...
              <input
                ...
                className="w-full border-b border-slate-300 dark:border-slate-600 bg-transparent pl-6 pr-8 py-2 text-sm text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 transition-colors"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 border border-slate-200 dark:border-slate-700 text-xs font-medium text-slate-500 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-600 transition-colors"
            >
              <svg
                width="12"
                height="12"
              ...
              >
                {sortName === "asc" ? (
                  ...
                  <path d="M16 15l-4 4-4-4M12 19V5" />
                )}
              </svg>
        ...
        {clients.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <p className="text-sm text-slate-400 dark:text-slate-500">
              {t("clients_no_match", { query: search })}
            </p>
            <button
              onClick={() => setSearch("")}
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-8 h-8 flex-shrink-0 flex items-center justify-center text-[11px] font-bold ${avatarColor(client.name)}`}
                            >
                              {initials}
                            </div>
                        ...
                        <td className="px-5 py-3.5">
                          {client.credit_terms ? (
                            <span className="inline-flex items-center px-2 py-0.5 text-[11px] font-medium bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 border border-slate-200 dark:border-slate-700">
                              {client.credit_terms}
                            </span>
                          ) : (
                            <span className="text-slate-300 dark:text-slate-700">
                        ...
                        <td className="px-5 py-3.5 text-end">
                          {hasBalance ? (
                            <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 text-red-700 dark:text-red-400 font-mono text-[12px] font-semibold tabular-nums">
                              ${balance.toFixed(2)}
                            </span>
                          ) : (
                        ...
                        <td className="px-4 py-3.5">
                          <button
                            ...
                            className="px-2.5 py-1 text-[11px] font-medium text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-emerald-400 hover:text-emerald-600 dark:hover:border-emerald-500 dark:hover:text-emerald-400 transition-colors"
                          >
                            {t("btn_adjust")}
                          </button>
                        </td>
