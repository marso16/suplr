    ...
    <div className="h-full flex flex-col">
      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-6 flex-shrink-0 flex items-start justify-between gap-4 flex-wrap">
        ...
        {invoices.length > 0 && (
          <button
            onClick={downloadCsv}
            className="flex items-center gap-1.5 text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 px-3.5 py-2 transition-colors flex-shrink-0"
          >
            <svg
              width="13"
              height="13"
        ...
        {invoices.length === 0 ? (
          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-4 py-3.5">
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-medium text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 dark:hover:border-slate-600 transition-colors"
                          >
                            <svg
                              width="11"
                              height="11"
                          ...
                          <button
                            ...
                            disabled={false}
                            className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-medium border transition-colors disabled:opacity-40 disabled:cursor-not-allowed text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700 hover:border-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 dark:hover:border-slate-600"
                          >
                            <svg
                              width="11"
                              height="11"
                          ...
                          {!inv.paid_at && (
                            <button
                              ...
                              className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-medium bg-emerald-500 hover:bg-emerald-600 text-white transition-colors disabled:opacity-50"
                            >
                              {paying === inv.id ? (
                                <svg
                                  width="11"
      ...
      {emailModal && (
        ...
        >
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 w-full max-w-sm mx-4 p-6">
            {emailStatus === "sent" ? (
              <div className="flex flex-col items-center gap-3 py-4">
                <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center">
                  <svg
                    width="22"
                    height="22"
                    fill="none"
                ...
                <button
                  ...
                  className="mt-2 px-4 py-2 text-sm font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
                >
                  {t("btn_close")}
                </button>
              </div>
              ...
              <>
                ...
                <label className="block text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">
                  Recipient email
                </label>
                <input
                  type="email"
                  ...
                  className="w-full mb-4 bg-transparent border-b border-slate-300 dark:border-slate-600 py-2 text-sm text-slate-800 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 transition-colors"
                />
                {emailStatus === "error" && (
                ...
                <div className="flex gap-2">
                  <button
                    onClick={closeEmailModal}
                    className="flex-1 px-4 py-2.5 text-sm font-medium border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                  >
                    {t("btn_cancel")}
                  </button>
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 text-sm font-medium bg-emerald-500 hover:bg-emerald-600 text-white transition-colors disabled:opacity-50 cursor-pointer"
                  >
                    {emailStatus === "sending" ? (
                      <>
                        <svg
