    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-2.5 justify-center mb-8">
          ...
          <span className="text-white font-semibold text-lg tracking-tight">Suplr</span>
        </div>

        <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
          <h1 className="text-white font-semibold text-lg mb-1">Create your account</h1>
          <p className="text-slate-400 text-sm mb-6">Start managing B2B orders via WhatsApp</p>
