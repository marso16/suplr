...
export function Sidebar({
  ...
  return (
    <aside
      className={[
        "w-64 bg-slate-950 flex flex-col flex-shrink-0 border-e border-slate-800/60",
    ...
    >
      ...
      <div className="px-4 pt-5 pb-4 flex items-center gap-2.5">
        ...
        <span className="text-white font-semibold text-[15px] tracking-tight flex-1">
          Suplr
        </span>
        {/* Close button — mobile only */}
        <button
          onClick={onClose}
          className="md:hidden text-slate-500 hover:text-slate-300 transition-colors p-1 -me-1"
      ...
      <nav className="flex-1 px-3 space-y-0.5 overflow-y-auto">
        {navKeys.map((item) => {
          ...
          return (
            ...
            >
              <span
                className={`flex-shrink-0 ${active ? "text-emerald-400" : "text-slate-500"}`}
              >
                {item.icon}
              </span>
      ...
      <div className="px-3 pb-4 pt-2 border-t border-slate-800/60 mt-2 space-y-1">
        ...
        <div className="flex items-center gap-1 px-3 py-2">
          <span className="text-slate-500 text-[11px] font-medium uppercase tracking-widest me-auto">
            Lang
          </span>
