...
function Toast({ toast, onDismiss }: { toast: ToastItem; onDismiss: (id: string) => void }) {
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-3 bg-slate-900 text-white px-5 py-3.5 rounded-2xl shadow-2xl border border-slate-700/60 min-w-[320px] max-w-sm pointer-events-auto"
    >
      {/* WhatsApp icon */}
      ...
      <button
        ...
        className="text-slate-500 hover:text-slate-300 transition-colors flex-shrink-0 p-0.5 cursor-pointer"
